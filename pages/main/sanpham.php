...
<div class="wrapper_chitiet">
    <div class="hinhanh_sanpham">
                <img width="100%" height="250px"  src="admincp/modules/quanlysp/uploads/<?php  echo $row_chitiet['hinhanh'] ?>" alt="">
    </div>
        ...
        <div class="col-rt-12">
            <div class="Scriptcontent">
                <div class="feedback">
                    ...
                    $sql = "SELECT * FROM tbl_comment, tbl_user WHERE tbl_comment.id_user = tbl_user.id_user AND tbl_comment.id_sanpham = '$_GET[id]' ORDER BY tbl_comment.id_comment DESC";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<p class='card-text'><strong>ID Người dùng:</strong> " . $row['name'] . "</p>";
